...
#save table as csv
write.csv(table_total,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/prediction_total.csv", row.names = TRUE)
...
write.csv(fix_items,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/fix_items.csv", row.names = TRUE)
...
write.csv(time_series_test,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/time_series_test.csv", row.names = TRUE)
...
# View(final_table)
#save table as csv
write.csv(final_table,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/completefinalprediction.csv", row.names = TRUE)
...
#save table as csv
write.csv(predicted_values_df,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/predicted_values_df.csv", row.names = TRUE)
...
write.csv(actual_values_df,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/actual_values_df.csv", row.names = TRUE)
...
# View(weekday_df)
#save table as csv
write.csv(weekday_df,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/weeklymeans.csv", row.names = TRUE)
...
#save table as csv
write.csv(weekday_df_total,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/weeklymeans_total.csv", row.names = TRUE)
...
#save table as csv
write.csv(monthly_means,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/monthlymeans.csv", row.names = TRUE)
# str(monthly_means)
# View(monthly_means)
...
#save table as csv
write.csv(month_df_total,"~/Desktop/Masterarbeit/Shiny_App/Shiny/prediction_output/monthlymeans_total.csv", row.names = TRUE)
